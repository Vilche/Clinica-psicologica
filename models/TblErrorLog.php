...
class TblErrorLog extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['us_id'], 'exist', 'skipOnError' => true, 'targetClass' => TblUsuarios::className(), 'targetAttribute' => ['us_id' => 'id_usuario']],
        ];
    }
    ...
    {
        return $this->hasOne(TblUsuarios::className(), ['id_usuario' => 'us_id']);
    }
}
