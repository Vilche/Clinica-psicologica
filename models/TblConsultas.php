...
/**
 * This is the model class for table "tbl_consultas".
 *
 ...
 */
class TblConsultas extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['motivo_consulta', 'estado_actual', 'id_paciente', 'id_conducta', 'id_prueba', 'id_tratamiento', 'user_ingreso', 'fecha_ingreso', 'user_modifico', 'fecha_modifico', 'activo'], 'required'],
            ...
            [['id_paciente', 'id_conducta', 'id_prueba', 'id_tratamiento', 'user_ingreso', 'user_modifico', 'activo'], 'integer'],
